...
//      Strongly based on PatternOptimizationIterate.hh
*/
...
namespace ShapeOptimization {
    ...
    struct Iterate : public IterateBase {
        ...
        NonPeriodicCellOperations<_Sim> &nonPeriodicCellOps()       { return *m_nonPeriodicCellOps; }
        const NonPeriodicCellOperations<_Sim> &nonPeriodicCellOps() const { return *m_nonPeriodicCellOps; }

        const VField &displacement() const { return m_nonPeriodicCellOps->displacement(); }
    ...
    protected:
        ...
        std::unique_ptr<NonPeriodicCellOperations<_Sim>> m_nonPeriodicCellOps;
    ...
    struct IFConfigBoundaryConditions : public PatternOptimization::IFConfig {
        ...
        void configIterate(const std::unique_ptr<_Iterate> &it, ObjectiveTermNormalizations &/* normalizations */) const {
            it->setBoundaryConditions(boundaryConditionsPath);
            it->solveIterationProblem();
        }
...
#endif //MICROSTRUCTURES_SHAPEOPTIMIZATIONITERATE_H
