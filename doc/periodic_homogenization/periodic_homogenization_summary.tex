...
\end{equation}
See \pr{apx:asymptotic} for more detail on the derivation of
\pr{set:cell} and \pr{eqn:effective}.
...
that variable. \pr{eqn:em1} implies a linear relationship between
