...
% \begin{align*}
%      -\nabla \cdot (E : e({\bf u}^{ij})) = {\bf 0} & \quad \text{in } \omega \\
% {\bf \hat n} \cdot (E : e({\bf u}^{ij})) = {\bf 0} & \quad \text{on } \partial \omega \setminus \partial Y \\
...
% \begin{equation}
%     \label{eqn:EhEnergy}
%     E^H_{ijkl} = \frac{1}{|Y|} \int_Y e({\bf u}^{ij}) : E : e({\bf u}^{kl}) \, \mathrm{d} {\bf y}.
% \end{equation}
