...
if len(sys.argv) != 5:
    print("usage: ./hexa-to-general-params.py <size of triangles (p1)> <num of pillars (p2)> <chirality (p3)> <relative thickness (of pillars) (p4)>")
    print("example: ./hexa-to-general-params.py 0.8 3 1.0 0.9")
    sys.exit(-1)
