...
$PATOPT/GenIsosurfaceJob -e "$young,$poisson" -o '-0.2,0.2' -r '0.04,0.2' $pattern > $jobfile

# NOTE: no timeout on this one--we're going to run without chunking
$MICRO_DIR/worst_case_stress/WCSOptimization_cli $jobfile --JSWeight 0.0 --WCSWeight 1.0 \
